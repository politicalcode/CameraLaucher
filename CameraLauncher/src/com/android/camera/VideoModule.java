...
public class VideoModule implements CameraModule,
    ...
    private void takeASnapshot() {
    	...
    	Log.e("takeASnapshot-----litb-----mIsVideoCaptureIntent", String.valueOf(mIsVideoCaptureIntent));
    	Log.e("takeASnapshot-----litb-----isVideoSnapshotSupported", String.valueOf(CameraUtil.isVideoSnapshotSupported(mParameters)));
