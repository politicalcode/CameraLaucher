...
public class FocusOverlayManager {
    ...
    public FocusOverlayManager(ComboPreferences preferences, String[] defaultFocusModes, Parameters parameters, Listener listener, boolean mirror, Looper looper, FocusUI ui) {
    ...
    public void setParameters(Parameters parameters) {
        ...
        mLockAeAwbNeeded = (CameraUtil.isAutoExposureLockSupported(mParameters) || CameraUtil.isAutoWhiteBalanceLockSupported(mParameters));
    }
    ...
    private void setMatrix() {
        if (mPreviewWidth != 0 && mPreviewHeight != 0) {
            ...
            CameraUtil.prepareMatrix(matrix, mMirror, mDisplayOrientation, mPreviewWidth, mPreviewHeight);
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        if ((!mFocusDefault) && (mState == STATE_FOCUSING || mState == STATE_SUCCESS || mState == STATE_FAIL)) {
            cancelAutoFocus();
        }
        if (mPreviewWidth == 0 || mPreviewHeight == 0)
            return;
    ...
    private boolean needAutoFocusCall() {
        ...
        return !(focusMode.equals(Parameters.FOCUS_MODE_INFINITY) || focusMode.equals(Parameters.FOCUS_MODE_FIXED) || focusMode.equals(Parameters.FOCUS_MODE_EDOF));
    }
}
